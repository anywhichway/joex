...
(function() {
	...
	Object.extend = function(overwrite) {
		...
		if(overwrite || !ExtendedObject.prototype.find) {
			ExtendedObject.prototype.find = function(f,thisarg) {
				var me = this;
				return me.some(function(value,key) {
					if(f.call(thisarg,value,key,me)) {
						return true;
					};
				});
			}
		...
		if(overwrite || !ExtendedObject.prototype.findKey) {
			ExtendedObject.prototype.findKey = function(f,thisarg) {
				var me = this, result;
		...
		if(overwrite || !ExtendedObject.prototype.findLastKey) {
			ExtendedObject.prototype.findLastKey = function(f,thisarg) {
				var me = this, result;
				me.forEach(function(value,key) {
					if(f.call(thisarg,value,key,me)) {
						result = key;
			...
			ExtendedObject.prototype.map = function(callback, thisArg) {
				  ...
				  return Object.keys(this)
				    .reduce(function(result, key) {
				      var value = callback.call(thisArg, me[key], key, me);
				      if(value!=undefined) {
				    	  result[key] = value;
				      }
				      return result;
